...
ui <- fluidPage(
  ...
  navbarPage("News Application Beta", theme = shinytheme("lumen"),
             tabPanel("News Finder", fluid = TRUE,
                      titlePanel("News Collection"),
             sidebarLayout(
             ...
             tabPanel("Analysing Data", fluid = TRUE,
                      titlePanel("Quanteda Functions"),
                      sidebarLayout(
                        actionButton(inputId = "clean",
                                     label = "Clean Dataset"),
                        actionButton(inputId = "freq",
